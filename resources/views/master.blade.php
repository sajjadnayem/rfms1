...
<head>
  ...
  <title>Radiant Foundation Dashboard | Dashboard</title>
  <!-- Favicon -->
  <link rel="shortcut icon" href="{{('Backend/img/svg/logo.svg')}}" type="image/x-icon">
  <!-- Custom styles -->
  <link rel="stylesheet" href="{{url('Backend/css/style.min.css')}}">
</head>
    ...
    <div class="sidebar-footer">
        <a href="##" class="sidebar-user">
            <span class="sidebar-user-img">
                <picture><source srcset="{{url('Backend/img/avatar/user_image.png')}}" type="image/webp"><img src="{{('Backend/img/avatar/user_image.png')}}" alt="User name"></picture>
            </span>
            <div class="sidebar-user-info">
                <span class="sidebar-user__title">Shahida Rahman Sara</span>
                <span class="sidebar-user__subtitle">System Admin</span>
            </div>
        </a>
    </div>
</aside> --}}
@include('admin.fixed.sidebar')
      ...
      <div class="nav-user-wrapper">
        <button href="##" class="nav-user-btn dropdown-btn" title="My profile" type="button">
          ...
          <span class="nav-user-img">
            <picture><source srcset="{{url('Backend/img/avatar/user_image.png')}}" type="image/webp"><img src="{{url('Backend/img/avatar/user_iamge.png')}}" alt="User name"></picture>
          </span>
        </button>
              ...
              <table class="posts-table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="pages-table-img">
                        <picture><source srcset="./img/avatar/avatar-face-03.webp" type="image/webp"><img src="{{url('Backend/img/avatar/user_image.png')}}" alt="User Name"></picture>
                        Robert Fox
                      </div>
                    </td>
                    <td><span class="badge-active">Active</span></td>
  ...
  <div class="container footer--flex">
    {{-- <div class="footer-start">
      <p>2021 © Radiant Foundation Dashboard - <a href="elegant-dashboard.com" target="_blank"
          rel="noopener noreferrer"></a></p><br>
          <p>Developed by - <a href="" target="_blank"
            rel="noopener noreferrer">Shahida Rahman Sara</a></p>
    </div> --}}
    {{-- <ul class="footer-end">
...
<!-- Chart library -->
<script src="{{url('Backend/plugins/chart.min.js')}}"></script>
<!-- Icons library -->
<script src="{{url('Backend/plugins/feather.min.js')}}"></script>
<!-- Custom scripts -->
